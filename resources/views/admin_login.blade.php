...
<head>
	...
	<!-- end: Favicon -->
			...
			<style type="text/css">
			body { 
                            background: url({{URL::to('backend/img/bg-login.jpg')}}) 
                        !important;
                        }
		</style>						
</head>
					...
					<div class="icons">
						...
						<a href="#"><i class="halflings-icon cog"></i></a>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="admin_email" id="username" type="email address" placeholder="type username"/>
							</div>
